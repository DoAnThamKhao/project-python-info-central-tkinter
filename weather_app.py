...
def getWeather():
    ...
    api = "https://api.openweathermap.org/data/2.5/onecall?lat=" + str(location.latitude) + "&lon=" + str(
        location.longitude) + "&units=metric&exclude=hourly&appid=bd5e378503939ddaee76f12ad7a97608"
    ...
    photo1 = ImageTk.PhotoImage(file=f"./image/weather/icon/{firstdayimage}@2x.png")
    ...
    img = (Image.open(f"./image/weather/icon/{seconddayimage}@2x.png"))
    ...
    img = (Image.open(f"./image/weather/icon/{thirddayimage}@2x.png"))
    resized_image = img.resize((50, 50))
    ...
    img = (Image.open(f"./image/weather/icon/{fourthdayimage}@2x.png"))
    resized_image = img.resize((50, 50))
    ...
    img = (Image.open(f"./image/weather/icon/{fifthdayimage}@2x.png"))
    resized_image = img.resize((50, 50))
    ...
    img = (Image.open(f"./image/weather/icon/{sixthdayimage}@2x.png"))
    resized_image = img.resize((50, 50))
    ...
    img = (Image.open(f"./image/weather/icon/{seventhdayimage}@2x.png"))
    resized_image = img.resize((50, 50))
...
## Icons Import
image_icon = PhotoImage(file="./image/weather/logo.png")
root.iconphoto(False, image_icon)

Round_box = Frame(root, bg="#203243", width=225, height=117)
Round_box.place(x=30, y=110)

# label
label1 = Label(Round_box, text="Temprature", font=('Helvetica', 11), fg="white", bg="#203243")
label1.place(x=5, y=5)

label2 = Label(Round_box, text="Humidity", font=('Helvetica', 11), fg="white", bg="#203243")
label2.place(x=5, y=25)

label3 = Label(Round_box, text="Pressure", font=('Helvetica', 11), fg="white", bg="#203243")
label3.place(x=5, y=45)

label4 = Label(Round_box, text="Wind Speed", font=('Helvetica', 11), fg="white", bg="#203243")
label4.place(x=5, y=65)

label5 = Label(Round_box, text="Description", font=('Helvetica', 11), fg="white", bg="#203243")
label5.place(x=5, y=85)

##search Box
Search_image = PhotoImage(file="./image/weather/Rounded Rectangle 3.png")
myimage = Label(image=Search_image, bg="#57adff")
myimage.place(x=300, y=120)

weat_image = PhotoImage(file="./image/weather/Layer 7.png")
weatherimage = Label(root, image=weat_image, bg="#203243")
weatherimage.place(x=320, y=127)
...
Search_icon = PhotoImage(file="./image/weather/Layer 6.png")
...
# Bottom Boxes
firstbox = PhotoImage(file="./image/weather/Rounded Rectangle 2.png")
secondbox = PhotoImage(file="./image/weather/Rounded Rectangle 2 copy.png")
...
timezone = Label(root, font=("Helvetica", 15), fg="white", bg="#57adff")
timezone.place(x=720, y=45)

long_lat = Label(root, font=("Helvetica", 10), fg="white", bg="#57adff")
long_lat.place(x=720, y=20)

# thpwd
t = Label(Round_box, font=("Helvetica", 11), fg="white", bg="#203243")
t.place(x=110, y=5)
h = Label(Round_box, font=("Helvetica", 11), fg="white", bg="#203243")
h.place(x=110, y=25)
p = Label(Round_box, font=("Helvetica", 11), fg="white", bg="#203243")
p.place(x=110, y=45)
w = Label(Round_box, font=("Helvetica", 11), fg="white", bg="#203243")
w.place(x=110, y=65)
d = Label(Round_box, font=("Helvetica", 11), fg="white", bg="#203243")
d.place(x=110, y=85)
